...
void mm_init_advanced(const void *fdt,
	...
	/* QEMU ramfb used by lab5.  The device is not described as reserved in
	 * the DTB, so keep the buddy allocator away from the framebuffer range. */
	add_reserved(0x87000000UL, 1920UL * 1080UL * 4UL);
